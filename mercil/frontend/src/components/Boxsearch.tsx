...
const Boxsearch = () => {
  ...
  const { search , clear} = useContext(SearchContext) || {}
    ...
    useEffect(() => {
      ...
      if (priceRange === "< 1 ล้าน") q += "ไม่เกิน 1 ล้าน ";
      if (priceRange === "1-3 ล้าน") q += "ไม่เกิน 3 ล้าน ";
      if (priceRange === "3-5 ล้าน") q += "ไม่เกิน 5 ล้าน ";
      if (priceRange === "5-10 ล้าน") q += "ไม่เกิน 10 ล้าน ";
      if (priceRange === "> 10 ล้าน") q += "มากกว่า 10 ล้าน ";

      if (area) q += "พื้นที่ " + area;
